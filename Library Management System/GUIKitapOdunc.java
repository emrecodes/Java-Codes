...
public class GUIKitapOdunc
{
    ...
    KontrolorKitapOdunc kontrolor;
    public GUIKitapOdunc()
    {
    ...
    public GUIKitapOdunc(KontrolorKitapOdunc k_kontrolor)
    {
        olayDinleyici = new OlayDinleyicisi();
    ...
    private class OlayDinleyicisi implements ActionListener
    {
       public void actionPerformed  (ActionEvent event)
       {
         if(event.getSource() == button_Kaydet)
          {
              kontrolor.KitapOdunc(Integer.parseInt(t_OgrenciNo.getText()),t_Adi.getText());
          }
